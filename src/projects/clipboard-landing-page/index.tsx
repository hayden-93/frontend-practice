    ...
    <div className={classes}>
      ...
      <main>
        <DownloadCard>
          ...
          <DownloadCard.Button></DownloadCard.Button>
        </DownloadCard>
        <section>
          ...
          <img src="/clipboard-landing-page/image-computer.png" alt="Image of Computer" />
          <h2>Quick Search</h2>
        ...
        <section>
          ...
          <img src="/clipboard-landing-page/image-devices.png" alt="Computer and Mobile Devices" />
