  ...
  return (
    <div className={classes}>
      ...
      <section className="mt-28">
        <div className="max-w-screen-xs mx-auto text-center space-y-4">
        ...
        <div className="flex mt-16 items-center">
          ...
          <div className="block ml-20 w-64 space-y-6">
            ...
            <Heading className="text-2xl font-semibold text-clipboard-dark-grayish-blue">Complete History</Heading>
            <Heading.Description className="text-sm">
      ...
      <section className="mt-24 max-w-screen-xs mx-auto text-center space-y-4">
      ...
      <section className="max-w-screen-md mx-auto text-center space-y-4">
        ...
        <div className="flex mt-14 justify-between">
          <div className="block max-w-screen-xxs mt-14 space-y-4">
