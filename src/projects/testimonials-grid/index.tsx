...
export function TestimonialsGrid({ className }: TestimonialsGridProps) {
  const classes = ["max-w-screen-desktop mx-auto p-4 space-y-4", className].join(" ").trim();
  return (
    <main className="bg-neutral-2">
      <div className={classes}>
        <section className="grid gap-6 mobile:gap-8 mobile:grid-cols-4">
          <Card bg="violet" className="mobile:col-span-2 mobile:order-1">
            <Card.Header>
              <div className="flex">
                <img
          ...
          <Card bg="darkGray" className="mobile:order-1">
            <Card.Header>
              <div className="flex">
                <img
            ...
            <Card.Content>
              <Card.Title>
                <h2 className="text-neutral-light-grayish-blue text-xl font-medium">
                  The team was very supportive and kept me motivated
                </h2>
              </Card.Title>
              <Card.Description>
                <p className="text-neutral-light-gray text-sm font-extralight">
          ...
          <Card className="mobile:order-2">
            ...
            <Card.Content>
              <Card.Title>
                <h2 className="text-neutral-main-dark-blue text-xl leading-tight">
                  An overall wonderful and rewarding experience
                </h2>
              </Card.Title>
              <Card.Description>
                <p className="text-neutral-main-dark-blue text-sm opacity-60 font-extralight">
          ...
          <Card bg="darkBlue" className="mobile:col-span-2 mobile:order-2">
            <Card.Header>
              <div className="flex">
                <img
            ...
            <Card.Content>
              <Card.Title>
                <h3 className="text-neutral-light-grayish-blue text-lg font-medium">
                  Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and
                  learning from their experiences was easy.
                </h3>
              </Card.Title>
              <Card.Description>
                <p className="text-neutral-light-grayish-blue text-sm opacity-50">
          ...
          <Card className="mobile:order-1 mobile:row-span-2">
            <Card.Header>
              <div className="flex">
                <img
            ...
            <Card.Content>
              <Card.Title>
                <h3 className="text-neutral-line-dark-blue text-lg font-semibold">
                  Such a life-changing experience. Highly recommended!
                </h3>
              </Card.Title>
              <Card.Description>
                <p className="text-neutral-line-dark-blue opacity-50 text-sm">
