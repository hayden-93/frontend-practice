...
export const Footer = ({ children, className }: PropsWithChildren<FooterProps>) => {
  ...
  return (
    <footer className={classes}>
      <svg width="124" height="24" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
        <path
  ...
  return (
    <div className={classes}>
      <nav className="flex space-x-12">
        <a href="#" className="block text-desat-cyan hover:text-white">
          About
        </a>
        <a href="#" className="block text-desat-cyan hover:text-white">
          Services
...
const FooterSocial = ({ className }: FooterSocialProps) => {
  const classes = ["flex justify-center max-w-screen-xxs mx-auto mt-10 space-x-6", className].join(" ").trim();
      ...
      <a href="#">
        <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
          <path
            ...
            fill="#2C7566"
            fill-rule="nonzero"
            className="fill-desat-cyan hover:fill-white"
          />
        </svg>
      </a>
      <a href="#">
